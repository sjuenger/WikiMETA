                    ...
                    tmp_occurrences = \
                        scenario_one_detection. \
                            scenario_one_occurrences({"where": where_part["patterns"]}, look_for,
                                                     bound_variables)
                    minus_statistical_information["metadata_found_in_scenarios"]["one"] += tmp_occurrences
                    ...
                    tmp_occurrences = \
                        scenario_two_detection. \
                            scenario_two_occurrences({"where": where_part["patterns"]}, look_for,
                                                     bound_variables)
                    minus_statistical_information["metadata_found_in_scenarios"]["two"] += tmp_occurrences
                    ...
                    tmp_occurrences = \
                        scenario_three_detection. \
                            scenario_three_occurrences({"where": where_part["patterns"]}, look_for,
                                                       bound_variables)
                    minus_statistical_information["metadata_found_in_scenarios"]["three"] += tmp_occurrences
                    ...
                    tmp_occurrences = \
                        scenario_four_detection. \
                            scenario_four_occurrences({"where": where_part["patterns"]}, look_for,
                                                      bound_variables)
                    minus_statistical_information["metadata_found_in_scenarios"]["four"] += tmp_occurrences
                    ...
                    tmp_occurrences = \
                        scenario_five_detection. \
                            scenario_five_occurrences({"where": where_part["patterns"]}, look_for,
                                                      bound_variables)
                    minus_statistical_information["metadata_found_in_scenarios"]["five"] += tmp_occurrences
                    ...
                    tmp_occurrences = \
                        scenario_six_detection. \
                            scenario_six_occurrences({"where": where_part["patterns"]}, look_for,
                                                     bound_variables)
                    minus_statistical_information["metadata_found_in_scenarios"]["six"] += tmp_occurrences
                    ...
                    tmp_occurrences = \
                        scenario_seven_detection. \
                            scenario_seven_occurrences({"where": where_part["patterns"]}, look_for,
                                                       bound_variables)
                    minus_statistical_information["metadata_found_in_scenarios"]["seven"] += tmp_occurrences
                    ...
                    tmp_occurrences = \
                        scenario_eight_detection. \
                            scenario_eight_occurrences({"where": where_part["patterns"]}, look_for,
                                                       bound_variables)
                    minus_statistical_information["metadata_found_in_scenarios"]["eight"] += tmp_occurrences
                    ...
                    tmp_occurrences = \
                        scenario_nine_detection. \
                            scenario_nine_occurrences({"where": where_part["patterns"]}, look_for,
                                                      bound_variables)
                    minus_statistical_information["metadata_found_in_scenarios"]["nine"] += tmp_occurrences
                    ...
                    tmp_occurrences = \
                        scenario_ten_detection. \
                            scenario_ten_occurrences({"where": where_part["patterns"]}, look_for,
                                                     bound_variables)
                    minus_statistical_information["metadata_found_in_scenarios"]["ten"] += tmp_occurrences
                    ...
                    tmp_occurrences = \
                        scenario_eleven_detection. \
                            scenario_eleven_occurrences({"where": where_part["patterns"]}, look_for,
                                                        bound_variables)
                    minus_statistical_information["metadata_found_in_scenarios"]["eleven"] += tmp_occurrences
                    ...
                    tmp_occurrences = \
                        scenario_twelve_detection. \
                            scenario_twelve_occurrences({"where": where_part["patterns"]}, look_for,
                                                        bound_variables)
                    minus_statistical_information["metadata_found_in_scenarios"]["twelve"] += tmp_occurrences
