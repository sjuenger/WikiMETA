...
def scenario_minus_occurrences(json_object, look_for, location, bound_variables, look_for_additional_layer):
        ...
        if where_part["type"] == "minus":
            if (look_for not in str(where_part["patterns"])):
                ...
                if look_for_additional_layer:
                    ...
                    minus_statistical_information["metadata_found_in_scenarios"]["bind"] += \
                    ...
                    # scenario literal
                    minus_statistical_information["metadata_found_in_scenarios"]["literal"] += \
                    ...
                    # scenario values
                    minus_statistical_information["metadata_found_in_scenarios"]["values"] += \
